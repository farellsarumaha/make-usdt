...
class TableTheme extends Tailwind
{
    ...
    public function table(): array
    {
        return [
            ...
            'header' => [
                ...
                'tr'       => '',
                'th'       => 'font-semibold px-3 py-3 text-left text-xs text-pg-primary-700 tracking-wider whitespace-nowrap dark:text-pg-primary-300',
                'thAction' => '!font-bold',
            ],
            ...
            'body' => [
                ...
                'td'                 => 'text-sm px-3 py-2 whitespace-nowrap dark:text-pg-primary-200',

...
final class UserTable extends PowerGridComponent
{
                ...
                Button::add('bulk-delete')
                    ->slot('
                        <span class="inline-flex justify-center items-center gap-1">
                            ...
                            <p class="hidden sm:block">Delete Selected</p>
                        </span>
                    ')
    ...
    public function fields(): PowerGridFields
    {
        return PowerGrid::fields()
            ...
            ->add('email_verified_at_label', function ($dish) {
                return Blade::render('<x-tables.verified-rows verified="' . $dish->email_verified_at . '"/>');
            })
            ->add('created_at');
    }
